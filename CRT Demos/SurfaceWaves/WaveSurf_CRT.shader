Shader "Simulation/Wave Surface From CRT"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void disp (inout appdata_full vertexData) 
        {
            ...
            hgt = tex2Dlod(_WaveMesh, float4(vertexData.texcoord.xy, 0, 0)).a;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = tex2D (_WaveMesh, IN.uv_WaveMesh);
            ...
            o.Alpha = 1;
            float v1 = smoothstep(-16,16,tex2D(_WaveMesh, IN.uv_WaveMesh - duv.xz).a);
            float v2 = smoothstep(-16,16,tex2D(_WaveMesh, IN.uv_WaveMesh + duv.xz).a);
            float v3 = smoothstep(-16,16,tex2D(_WaveMesh, IN.uv_WaveMesh - duv.zy).a);
            float v4 = smoothstep(-16,16,tex2D(_WaveMesh, IN.uv_WaveMesh + duv.zy).a);
